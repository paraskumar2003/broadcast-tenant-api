...
let WebhookController = WebhookController_1 = class WebhookController {
    ...
    verify(mode, token, challenge, res) {
        const expectedToken = this.configService.get('webhook.verifyToken');
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Webhook verification endpoint' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Receive webhook events from Meta' }),
