...
export declare class MessagingController {
    ...
    sendBulkCsv(file: Express.Multer.File, projectConfigId: string, templateStr: string, language?: string, scheduledAt?: string, skipBroadcast?: string, broadcastName?: string, variableMappingStr?: string, staticParamsStr?: string): Promise<ApiResponseDto<{
        sessionId: import("mongoose").Types.ObjectId;
        totalQueued: number;
